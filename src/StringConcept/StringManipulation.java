...
//		System.out.println(str.charAt(-1));//-SIOB
      ...
      System.out.println(dob);
       ...
       System.out.println(loop.substring(0, 10));
       System.out.println(loop.subSequence(loop.indexOf("is")+3, loop.length()));
      System.out.println(loop.subSequence(loop.indexOf("12"), loop.length()));
     ...
     System.out.println(p[0]);//blank-empty
     ...
     String empInfo="Ravi;Sharam;IBM;Pune;India;QA";
